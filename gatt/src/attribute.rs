...
impl Attribute {
    ...
    pub(crate) fn permission(&self) -> Permission {
        match self {
            ...
            Self::CharacteristicValue { permission, .. } => permission.clone(),
            Self::CharacteristicExtendedProperties { .. } => Permission::READABLE,
            Self::CharacteristicUserDescription { permission, .. } => permission.clone(),
            Self::ClientCharacteristicConfiguration { permission, .. } => permission.clone(),
            Self::ServerCharacteristicConfiguration { permission, .. } => permission.clone(),
